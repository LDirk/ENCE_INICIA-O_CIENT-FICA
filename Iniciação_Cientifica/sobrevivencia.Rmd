...
ekm.cat_idade_2015= svykm(Surv(as.numeric(tempo,censura))~cat_idade_2015,design=desenhobr) 
...
#  Escolaridade da mãe.
```{r}
ekm.ensino_mae = svykm(Surv(as.numeric(tempo,censura))~VB01008A,design=desenhobr)
