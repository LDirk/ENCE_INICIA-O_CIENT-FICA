...
#Norte
plot(ekm.regiao$"1", xlim = c(7,19), xlab = "Tempo(anos)", ylab="S(t) estimada", col ="red", lty = 1)
legenda = c("Norte")
legend("bottomleft",legenda, lwd=c(1,1),cex = 1, inset = 0.00, col = c('red'), bty="n",lty = c(1))


#Nordeste

plot(ekm.regiao$"2", xlim = c(7,19), xlab = "Tempo(anos)", ylab="S(t) estimada", col ="black", lty = 1)
legenda = c("Nordeste")
legend("bottomleft",legenda, lwd=c(1,1),cex = 1, inset = 0.00, col = c('black'), bty="n",lty = c(1))


#Sudeste 

plot(ekm.regiao$"3", xlim = c(7,19), xlab = "Tempo(anos)/ Nordeste", ylab="S(t) estimada", col ="blue", lty = 1)
legenda = c("Sudeste")
legend("bottomleft",legenda, lwd=c(1,1),cex = 1, inset = 0.00, col = c('blue'), bty="n",lty = c(1))


# Sul 

plot(ekm.regiao$"4", xlim = c(7,19), xlab = "Tempo(anos)", ylab="S(t) estimada", col ="green", lty = 1)
legenda = c("Sul")
legend("bottomleft",legenda, lwd=c(1,1),cex = 1, inset = 0.00, col = c('green'), bty="n",lty = c(1))


#Centro-Oeste

plot(ekm.regiao$"5", xlim = c(7,19), xlab = "Tempo(anos)", ylab="S(t) estimada", col ="pink", lty = 1)
legenda = c("Centro-Oeste")
legend("bottomleft",legenda, lwd=c(1,1),cex = 1, inset = 0.00, col = c('pink'), bty="n",lty = c(1))
...
ekm.cat_idade_2015= svykm(Surv(tempo,censura)~cat_idade_2015,design=desenhobr) 
